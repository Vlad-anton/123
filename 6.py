...
vk_session = vk_api.VkApi(token='7106b34491f0a4a7c0b02563afd256eeaac035534800689df1e47764ccc95b9333b883c8eac80241ef7d2') #токен вашей группы
vk = vk_session.get_api()
longpoll = VkBotLongPoll(vk_session,213255829) #цифровой id вашей группы
def main():
