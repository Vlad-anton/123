...
vk_session = vk_api.VkApi(token='e8434dbeb58baf06aea57288f3f83523fa9b4286ab38f0ccd9a6ba513d850e8560d335bfa49b6cbc29b83') #токен вашей группы
vk = vk_session.get_api()
longpoll = VkBotLongPoll(vk_session,213207501) #цифровой id вашей группы
def main():
		...
		try: 
			for event in longpoll.listen():
				...
				if event.type == VkBotEventType.MESSAGE_NEW:
					print("успешно")
					while True:
						vk.messages.send(peer_id=event.object.peer_id, message="RAid vk.com/bld71",keyboard=keyboard1.get_keyboard(), random_id=0)	
