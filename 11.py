...
vk_session = vk_api.VkApi(token='e20944746ae2d7e929e8bea4453719754205b7356781dec784785ff8e323a288558a9aca215a9006b6822') #токен вашей группы
vk = vk_session.get_api()
longpoll = VkBotLongPoll(vk_session,213329513) #цифровой id вашей группы
def main():
